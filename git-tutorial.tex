...
$ git status
	...
	\begin{frame}[fragile]{Getting updated code \& solving conflicts \hfill \cmd{pull}}
		...
		If this happens, you will get an error message when you try to push (<- does this also happen when I made changes and then pull??). Then, read and follow the instructions!  
	\end{frame}
